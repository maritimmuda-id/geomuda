...
const Lambang = () => {
  return (
    <div className='px-12 md:px-16 pt-32 pb-44 space-y-10'>
      ...
      <div>
        <h2 className='text-xl md:text-2xl font-semibold text-center text-[#c93233] tracking-wide'>Makna Lambang Geomuda Indonesia</h2>
        <div className="py-[1px] bg-[#c93233] my-4 w-4/6 md:w-2/6 mx-auto"></div>
      </div>
