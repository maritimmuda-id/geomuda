  ...
  return (
    <div className="flex items-center h-screen bg-slate-100">
      <div className="basis-4/12">
        <Image src={assets.sideImage} alt="side image" className="h-screen w-full" priority={true} />
      </div>
        {/* <Image src={assets.sideImage} alt="side image" className="w-3/12 h-screen" /> */}
      {/* <div className="w-3/12 h-screen">
      </div> */}
      <div className="basis-8/12">
        <div className='p-6 md:p-10 max-w-lg shadow-2xl rounded-xl bg-slate-50 mx-auto'>
          <Image src={assets.logoGmiDefault} className="w-32 mx-auto" alt="logo geomuda indonesia"/>
          ...
          <form className='flex justify-center flex-col mx-auto'>
            ...
            <button className='bg-[#7B2418] text-white rounded-xl p-2 mb-4'>Login</button>
          </form>
